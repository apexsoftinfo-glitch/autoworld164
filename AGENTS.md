...
AutoWorld164 to menedżer kolekcji aut w skali 1/64 (Hot Wheels, Majorette, Matchbox). Umożliwia katalogowanie modeli, przechowywanie zdjęć i śledzenie ich wartości finansowej.
Pełny opis produktu znajduje się w pliku docs/IDEA.md.
