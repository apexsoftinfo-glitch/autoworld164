...
mixin _$MarketCarModel {
 ...
 String get id;@JsonKey(name: 'user_id') String get userId; String get brand;@JsonKey(name: 'model_name') String get modelName;@JsonKey(name: 'toy_maker') String? get toyMaker; String? get series; double get price;@JsonKey(name: 'photo_paths') List<String> get photoPaths; String get status;@JsonKey(name: 'is_exchange') bool get isExchange;@JsonKey(name: 'is_sale') bool get isSale;@JsonKey(name: 'created_at') DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,brand,modelName,toyMaker,series,price,const DeepCollectionEquality().hash(photoPaths),status,isExchange,isSale,createdAt);

@override
String toString() {
  return 'MarketCarModel(id: $id, userId: $userId, brand: $brand, modelName: $modelName, toyMaker: $toyMaker, series: $series, price: $price, photoPaths: $photoPaths, status: $status, isExchange: $isExchange, isSale: $isSale, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId, String brand,@JsonKey(name: 'model_name') String modelName,@JsonKey(name: 'toy_maker') String? toyMaker, String? series, double price,@JsonKey(name: 'photo_paths') List<String> photoPaths, String status,@JsonKey(name: 'is_exchange') bool isExchange,@JsonKey(name: 'is_sale') bool isSale,@JsonKey(name: 'created_at') DateTime createdAt
});
...
/// Create a copy of MarketCarModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? brand = null,Object? modelName = null,Object? toyMaker = freezed,Object? series = freezed,Object? price = null,Object? photoPaths = null,Object? status = null,Object? isExchange = null,Object? isSale = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  String brand, @JsonKey(name: 'model_name')  String modelName, @JsonKey(name: 'toy_maker')  String? toyMaker,  String? series,  double price, @JsonKey(name: 'photo_paths')  List<String> photoPaths,  String status, @JsonKey(name: 'is_exchange')  bool isExchange, @JsonKey(name: 'is_sale')  bool isSale, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MarketCarModel() when $default != null:
return $default(_that.id,_that.userId,_that.brand,_that.modelName,_that.toyMaker,_that.series,_that.price,_that.photoPaths,_that.status,_that.isExchange,_that.isSale,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  String brand, @JsonKey(name: 'model_name')  String modelName, @JsonKey(name: 'toy_maker')  String? toyMaker,  String? series,  double price, @JsonKey(name: 'photo_paths')  List<String> photoPaths,  String status, @JsonKey(name: 'is_exchange')  bool isExchange, @JsonKey(name: 'is_sale')  bool isSale, @JsonKey(name: 'created_at')  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _MarketCarModel():
return $default(_that.id,_that.userId,_that.brand,_that.modelName,_that.toyMaker,_that.series,_that.price,_that.photoPaths,_that.status,_that.isExchange,_that.isSale,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,brand,modelName,toyMaker,series,price,const DeepCollectionEquality().hash(_photoPaths),status,isExchange,isSale,createdAt);
...
/// Create a copy of MarketCarModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? brand = null,Object? modelName = null,Object? toyMaker = freezed,Object? series = freezed,Object? price = null,Object? photoPaths = null,Object? status = null,Object? isExchange = null,Object? isSale = null,Object? createdAt = null,}) {
