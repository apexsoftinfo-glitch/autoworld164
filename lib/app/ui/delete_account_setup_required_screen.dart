...
class DeleteAccountSetupRequiredScreen extends StatelessWidget {
  const DeleteAccountSetupRequiredScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final agentPrompt = l10n.deleteAccountSetupAgentPrompt;
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 24),
                            _CodePathCard(
                              label: l10n.deleteAccountGuideLabel,
                              value: l10n.deleteAccountGuideFile,
                            ),
                            ...
                            _HintCard(
                              ...
                              title: l10n.deleteAccountAiPromptTitle,
